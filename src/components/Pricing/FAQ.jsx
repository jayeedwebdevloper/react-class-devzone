            ...
            <div className="container mx-auto px-[1%] lg:px-[100px]">
                <div className="flex justify-center items-center gap-4 flex-col lg:flex-row">
                    <div className="w-full lg:w-1/2">
                        ...
                        <p className="py-12 text-md leading-[1.4] tracking-wider text-slate-600">Each demo built with Teba will look different. You can customize almost anything in the appearance of your website with only</p>
